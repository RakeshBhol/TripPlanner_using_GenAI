""" Place search with Tavily /GoogelAPI"""
...
class TavilyPlaceSearchTool:
    ...
    #       - "operation": One of ["attractions","resturants", "activities", "transportation"]
    ...
    #        result = self.tavily_search_attractions(place)
    #    elif operation == 'resturants':
    #        result = self.tavily_search_restaurants(place)
    #    elif operation == 'activities':
    #        result = self.tavily_search_activity(place)
    #    elif operation == 'transporation':
    #        result = self.tavily_search_transportation(place)
    #    else:
    #        return (f'UnSupported operation `{operation}`, Choose from attraction, resturants, activities, or transportaion..')
